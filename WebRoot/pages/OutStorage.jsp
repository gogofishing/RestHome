...
<head>
    ...
    <body>
       <jsp:include page="Header.jsp"/>
                    ...
                    <div class="content">
                        ...
                        <div class="content-breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li><h6><a href="<%=basePath %>pages/OutStorage.jsp">出库记录</a></h6></li>
                            </ul>
                        </div>
                        <div class="content-body">                         
                          
                       		<div class="row-fluid" id="outStorage_table_toolbar">
                                <div class="span12">
                                    <div class="box corner-all">  
                                                 ...
                                                 <div class="span4">
														<div class="controls">		                                                    
		                                                        <div class="input-append">
		                                                            <input type="text" id="outStorage_goodsName" class="grd-white" style="height:30px" 
                                                ...
                                                <div class="span4">
														<div class="controls">		                                                    
		                                                    <div class="input-append date" data-form="datepicker" data-date="" data-date-format="yyyy-mm-dd">
						                         				<input id="outStorage_outDate" class="grd-white" style="height:30px;disabled:disabled;" size="16"
						                         				placeholder="请输入出库日期查询" type="text" />
                                                 ...
                                                 <div class="span3">
														<div class="controls">
		                                                    <div class="form-search">
		                                                    	 <button type="button" id="outStorage_search" class="btn btn-info">搜索</button>
		                                                    </div>
		                                                </div>
		                                         </div>												
											</div>
										<!-- 列表显示 -->
                                            <table id="outStorage_table" class="table table-hover responsive">
	                                            <thead>
													<tr>
														<th style='display:none;'>uuid</th>
														<th><span class="badge">物品编号</span></th>
														<th><span class="badge">物品名称</span></th>
														<th><span class="badge">提货员编号</span></th>	
														<th><span class="badge">提货员姓名</span></th>							
														<th><span class="badge">出库数量</span></th>
														<th><span class="badge">出库日期</span></th>
	                                    ...
	                                    <!-- 分页 -->   
	                                        <div class='row-fluid'>
	                                         	<div class="span6">
	                                         		<div id="outStorage_paging" class="dataTables_paginate paging_bootstrap pagination">
	                                       				<ul>
	                                       				</ul>
                                        			</div>
	                                			</div>
		...
		<script src="<%=basePath%>pages/js/storage/outStorage.js"></script>
    </body>
</html>
