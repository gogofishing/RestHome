...
<body>
						...
						<div class="span12">
							<div class="box corner-all">
								<div class="box-header grd-white corner-top">
									...
									<input class="btn btn-info" type="button" value="添加参数" onclick="javascript:addLink();">
								</div>
								<div class="box-body">
									<!--  表格顶部的菜单- -->
									<div class='row-fluid'>
										<!-- <div class="input-icon-append">																							
											参数昵称:&nbsp;&nbsp;<input type="text" id="metaNickName" >
											&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;																	
										...
										<div id="addlink1" style="display: none">
											...
											<center>参数昵称:&nbsp;&nbsp;<input style="height: 30px" class="grd-white" type="text" id="metaNickName" ><br>
											<lable style="color: red" id="metaNickName_Lable"></lable>
											</center>
											<br>
											<center>
											<input class="btn btn-info" id="add" type="reset" value="添加"></center><br>
										</div>

											<!-- 修改 -->
											<div id="DialogDiv" style="display:none ">
												<h2 id="bianji">
													<span>编辑参数：</span> <a href="#" id="btnClose">关闭</a>
												</h2>
												<div class="form"></div>
												<input id="uuid" type="hidden" name="systemMetaVo.uuid">
												<center>
													参数昵称：<input type="text" style="height: 30px" class="grd-white" id="nickName" name="systemMetaVo.metaNickName"><br>
													<lable style="color: red" id="nickName_Lable"></lable>
												</center>
												<br>
												<center>
	...
	<script type="text/javascript"
		src="<%=basePath%>pages/js/systemMeta/systemMetaManager.js"></script>
